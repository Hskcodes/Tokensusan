...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002353972811"))
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002394700113"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "7964316543 6703858774").split()):
        ADMINS.append(int(x))
except ValueError:
