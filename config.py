...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002486874242"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002419794891"))
...
DB_URL = os.environ.get("DB_URL", "mongodb+srv://zbheaven:zbheaven@zbheaven.g6lrq.mongodb.net/?retryWrites=true&w=majority&appName=Zbheaven")
#your database name
DB_NAME = os.environ.get("DB_NAME", "Zbheaven")
...
# SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "cd7c238960c49d5dc74f2c77b8a2fd06e915750d")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "7665316226 6703858774").split()):
        ADMINS.append(int(x))
except ValueError:
